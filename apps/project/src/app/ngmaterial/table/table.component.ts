 ...
 * https://github.com/tuacy/angular-cdk-study
 */
...
export class TableComponent implements OnInit {
  ...
  heroesDataSource$ = this.tableDataSource$.asObservable();

  currentPages$ = new BehaviorSubject<number>(1);
  ...
  init() {
    ...
    combineLatest([this.tableDataSource$, this.currentPages$, this.pageSize$])
